...
CREATE TABLE `xxl_job_log` (
  ...
  `email_alarm_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '邮件告警状态：0-默认、1-无需告警、2-告警成功、3-告警失败',
  `sms_alarm_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '短信告警状态：0-默认、1-无需告警、2-告警成功、3-告警失败',
  `ding_robot_alarm_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '钉钉机器人告警状态：0-默认、1-无需告警、2-告警成功、3-告警失败',
  PRIMARY KEY (`id`),
